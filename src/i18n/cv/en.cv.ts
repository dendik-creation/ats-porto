...
,
  ...
  certificates: [
    { type: 'award', name: '1st Place, AWS Club Competition', issuer: 'Central Java', date: '2023-11', summary: 'Built a school-profile website surfacing activities and administration, using WordPress and converting it to a static site via a WordPress plugin.', image: '/static/certifications/awards/1st_aws_project.webp' },
    { type: 'award', name: '3rd Place, LKS Web Technologies', issuer: 'Batang City', date: '2023-05', summary: 'Provincial competitive-programming event: native HTML5/CSS/JS/PHP tasks, a Plants vs. Zombies clone game, and a job-seeker REST API built with Laravel and Vue for the frontend.', image: '/static/certifications/awards/3rd_province_web_tech.webp' },
    { type: 'certification', name: 'Belajar Dasar Cloud dan Gen AI di AWS', issuer: 'Dicoding', date: '2026', summary: 'Fundamentals of AWS Cloud computing and generative AI prompt engineering models.', credentialId: '3XE1QNMVZRN', url: 'https://www.dicoding.com/certificates/53XE1QNMVZRN', image: '/static/certifications/certificate/dicoding_cloud_gen_ai.webp' },
    { type: 'certification', name: 'Spec-Driven Development dengan Kiro', issuer: 'Dicoding', date: '2026', summary: 'Spec-driven backend API design and documentation using modern development toolkits.', credentialId: 'GRX5WOM4KZ0M', url: 'https://www.dicoding.com/certificates/GRX5WOM4KZ0M', image: '/static/certifications/certificate/dicoding_kiro_sdd.webp' },
    { type: 'certification', name: 'Microsoft Office Specialist - Excel 2019', issuer: 'Microsoft', date: '2026', summary: 'Professional competency certification in advanced spreadsheet modeling and data analysis.', credentialId: 'wNMEx-2FNW', url: 'https://www.certiport.com/portal/pages/credentialverification.aspx', image: '/static/certifications/certificate/microsoft_office_specialsit.webp' },
