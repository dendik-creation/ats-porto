...
,
  ...
  certificates: [
    { type: 'award', name: '1st Place, AWS Club Competition', issuer: 'Central Java', date: '2023-11', summary: 'Built a school-profile website surfacing activities and administration, using WordPress and converting it to a static site via a WordPress plugin.', image: '/static/sections/certification/awards/1st_aws_project.png' },
    { type: 'award', name: '3rd Place, LKS Web Technologies', issuer: 'Batang City', date: '2023-05', summary: 'Provincial competitive-programming event: native HTML5/CSS/JS/PHP tasks, a Plants vs. Zombies clone game, and a job-seeker REST API built with Laravel and Vue for the frontend.', image: '/static/sections/certification/awards/3rd_province_web_tech.png' },
    { type: 'certification', name: 'Belajar Dasar Cloud dan Gen AI di AWS', issuer: 'Dicoding', date: '2026', summary: 'Fundamentals of AWS Cloud computing and generative AI prompt engineering models.', credentialId: '3XE1QNMVZRN', url: 'https://www.dicoding.com/certificates/53XE1QNMVZRN', image: '/static/sections/certification/certificate/dicoding_cloud_gen_ai.png' },
    { type: 'certification', name: 'Spec-Driven Development dengan Kiro', issuer: 'Dicoding', date: '2026', summary: 'Spec-driven backend API design and documentation using modern development toolkits.', credentialId: 'GRX5WOM4KZ0M', url: 'https://www.dicoding.com/certificates/GRX5WOM4KZ0M', image: '/static/sections/certification/certificate/dicoding_kiro_sdd.png' },
    { type: 'certification', name: 'Microsoft Office Specialist - Excel 2019', issuer: 'Microsoft', date: '2026', summary: 'Professional competency certification in advanced spreadsheet modeling and data analysis.', credentialId: 'wNMEx-2FNW', url: 'https://www.certiport.com/portal/pages/credentialverification.aspx', image: '/static/sections/certification/certificate/microsoft_office_specialsit.png' },
    { type: 'certification', name: 'Junior Web Programmer (BNSP)', issuer: 'LSP Teknologi Digital', date: '2023-11', endDate: '2026-11', summary: 'Nationally certified competency in database administration with the Django framework.', credentialId: '11843220', url: 'https://drive.google.com/file/d/1YCEHNxRW3Ozu3bG5S3soIc36eec1U09N/view', image: '/static/sections/certification/certificate/lsp_juniorweb.png' },
    { type: 'certification', name: 'AWS Cloud Practitioner Essentials', issuer: 'AWS Training', date: '2023-06', summary: 'Cloud fundamentals: core AWS services, pricing, and the shared-responsibility model.', credentialId: '', url: 'https://drive.google.com/file/d/1kmqZlREcC-7_XKkVaYcYs3e3anfZKHgw/view?usp=sharing', image: '/static/sections/certification/certificate/aws_cloud_practitioner_essentials.png' },
    { type: 'certification', name: 'AWS Technical Essentials', issuer: 'AWS Training', date: '2023-06', summary: 'Hands-on practice with EC2, VPC, and DynamoDB for compute, networking, and managed data storage.', credentialId: '', url: 'https://drive.google.com/file/d/1DPSi0J1MBvLrQ0gFh8OZwuhHBeR0Gs7H/view?usp=sharing', image: '/static/sections/certification/certificate/aws_technical_essentials.png' },
    { type: 'certification', name: 'Architecting on AWS', issuer: 'AWS Training', date: '2023-06', summary: 'Cloud architecture patterns for designing and troubleshooting solutions across the AWS ecosystem.', credentialId: '', url: 'https://drive.google.com/file/d/1_AzOVgRNSHhYFN_Hrnxm8Be1X5wKlBHA/view?usp=sharing', image: '/static/sections/certification/certificate/aws_architecting.png' },
    { type: 'certification', name: 'Certificate of Laziness', issuer: 'Ingin Menjadi Programmer Handal Namun Enggan Ngoding', date: '2025-07', summary: 'In recognition of outstanding commitment to maintaining Facebook activity during critical work periods. Your consistency, focus, and dedication to doing anything but the assigned task are truly commendable.', image: '/static/sections/certification/certificate/imphnen_lazy.png' },
  ],
  languages: [
